-- Limpar dados de demo existentes primeiro (para evitar conflitos)
DELETE FROM public.project_files WHERE id LIKE '30000000-%';
DELETE FROM public.project_tasks WHERE id LIKE '20000000-%';
DELETE FROM public.projects WHERE id LIKE '10000000-%';
...
-- Inserir projetos de demonstração com enum corretos
