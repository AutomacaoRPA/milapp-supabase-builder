-- Migração completa do MILAPP v2.0
...
INSERT INTO milapp.users (email, name, role, department) VALUES
('admin@medsenior.com.br', 'Administrador MILAPP', 'admin', 'TI'),
('user@medsenior.com.br', 'Usuário Teste', 'user', 'Financeiro');

-- Inserir projeto de exemplo
INSERT INTO milapp.projects (name, description, created_by, status) VALUES
('Automação de Notas Fiscais', 'Processo de aprovação automática de notas fiscais', 
 (SELECT id FROM milapp.users WHERE email = 'admin@medsenior.com.br'), 'development'); 